...
wget https://artifacts.chirpstack.io/downloads/chirpstack-network-server/chirpstack-network-server_3.16.5_linux_armv7.deb
wget https://artifacts.chirpstack.io/downloads/chirpstack-application-server/chirpstack-application-server_3.17.8_linux_armv7.deb
wget https://artifacts.chirpstack.io/downloads/chirpstack-gateway-bridge/chirpstack-gateway-bridge_3.14.5_linux_armv7.deb

#3.3 install chirpstack packages
dpkg -i chirpstack-application-server_3.17.8_linux_armv7.deb
dpkg -i chirpstack-gateway-bridge_3.14.5_linux_armv7.deb
dpkg -i chirpstack-network-server_3.16.5_linux_armv7.deb
