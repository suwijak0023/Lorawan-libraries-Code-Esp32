...
#if GATEWAYNODE==1
#define _DEVADDR { 0x26, 0x0D, 0x26, 0x15 }
#define _APPSKEY { 0x99, 0x88, 0xFA, 0xFD, 0xBC, 0x17, 0xD0, 0xE4, 0xC4, 0x22, 0xBD, 0x15, 0x4E, 0x13, 0x03, 0x5B }
#define _NWKSKEY { 0x9A, 0xDD, 0x41, 0x14, 0x32, 0x45, 0x65, 0xDC, 0x43, 0x86, 0x5C, 0x11, 0xA8, 0x6C, 0x65, 0x71 }
